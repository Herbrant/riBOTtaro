...
class Cart2DRobot(RoboticSystem):
    ...
    def __init__(self):
        ...
        self.left_controller = PIDSat(2, 2, 0, 5, True)
        self.right_controller = PIDSat(2, 2, 0, 5, True)


        self.target = (0.7, 0.4)
        self.linear_speed_profile_controller = SpeedProfileGenerator2D(self.target, 0.5, 0.2, 0.2)

        self.angular_speed_profile_controller = SpeedProfileGenerator(0, 0.5, 0.2, 0.2)
